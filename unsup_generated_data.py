...
experiment_dir = output_dir / 'generated_unsupervisied_aae'
experiment_dir.mkdir(exist_ok=True)

latent_space_dir = experiment_dir / 'test'
...
for i in range(1000):
    noise = tf.random.normal([1, 784], mean=2, stddev=2)
    img = generator(noise, training=False)
    noise_dataset.append(img)

training_data = np.array(noise_dataset)
